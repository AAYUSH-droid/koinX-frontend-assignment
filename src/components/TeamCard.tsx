function TeamCard() {
  return (
    <div className='bg-white h-max rounded-lg my-5 lg:p-6 p-2'>
      <div>
        <div className='text-[24px] leading-[28.8px] text-[#0F1629] font-semibold'>
          Team
        </div>
        <div className='text-[#3E424A] text-[16px] leading-[25.6px] font-medium my-4 pt-2'>
...
function Card({ name, link, description }: any) {
  return (
    <div className='md:flex bg-[#E8F4FD] rounded-lg py-4 md:px-8 my-6'>
      <div className='justify-center flex flex-col items-center'>
        ...
        <div className='text-[#0F1629] text-[15px] font-semibold py-1 leading-[18.15px] text-center'>
          {name}
        </div>
        <div className='text-[#788F9B] text-[12px] font-medium leading-[14.52px]'>
          {description}
        </div>
      </div>
      <div className='flex justify-center items-center px-4 ml-4 text-[#0F1629] text-[14px] leading-[22.4px] font-normal'>
