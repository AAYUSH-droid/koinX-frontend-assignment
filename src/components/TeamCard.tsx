function TeamCard() {
  return (
    <div className='bg-white h-max rounded-lg my-5 p-6'>
      <div>
        <div className='text-2xl text-[#0F1629] font-semibold font-inter leading-[28.8px]'>
          Team
        </div>
        <div className='text-[#3E424A] text-[16px] font-medium my-4 pt-2 font-inter leading-[25.6px]'>
...
function Card({ name, link, designation }: any) {
  return (
    <div className='flex bg-[#E8F4FD] rounded-lg py-4 px-8 my-6'>
      <div className='justify-center flex flex-col items-center'>
        ...
        <div className='text-[#0F1629] text-[15px] font-semibold py-1 font-inter leading-[18.15px] text-center'>
          {name}
        </div>
        <div className='text-[#788F9B] text-xs font-medium font-inter text-center leading-[14.52px]'>
          {designation}
        </div>
      </div>
      <div className='flex justify-center items-center px-4 ml-4 text-[#0F1629] text-sm font-normal font-inter leading-[22.4px]'>
