...
function SentimentSection() {
  return (
    <div className='bg-white h-max rounded-lg my-5 lg:p-6 p-3 font-inter'>
      <div>
        <div className='text-2xl font-semibold text-[#0F1629] leading-[28.8px]'>
          Sentiment
        </div>
          ...
          <div className='lg:w-[456px]  bg-[#E8F4FD] h-[204px] rounded-xl overflow-y-hidden'>
            <div className='p-4 flex'>
              ...
              <div className='ml-2 w-[calc(100%-3rem)] '>
                <div className='lg:text-sm text-xs font-medium text-[#191C1F] whitespace-normal leading-[20px]'>
                  Lorem ipsum dolor sit amet consectetur. Dui vel quis dignissim
                  mattis enim tincidunt.
                </div>
                <div className='text-sm font-normal text-[#3E5765] whitespace-normal mt-2 leading-[20px]'>
          ...
          <div className='lg:w-[456px] bg-[#EBF9F4] h-[204px] rounded-xl lg:ml-4 mt-4 lg:mt-0 overflow-y-hidden'>
            <div className='p-4 flex'>
              ...
              <div className='ml-2 w-[calc(100%-3rem)]'>
                ...
                <div className='lg:text-sm text-xs font-normal text-[#3E5765] whitespace-normal leading-[20px] mt-2 over'>
                  Lorem ipsum dolor sit amet consectetur. Ac phasellus risus est
                  faucibus metus quis. Amet sapien quam viverra adipiscing
                  condimentum. Ac consectetur et pretium in a bibendum in. Sed
                  vitae sit nisi viverra natoque lacinia libero enim.
        ...
        <div className='mb-6'>
          <div className='flex items-center py-4 mt-6'>
            <div className='text-[#44475B] font-semibold text-xl leading-[20px]'>
              Analyst Estimates
            </div>
            <div className=''>
              <IoMdInformationCircle className='text-[#ABB9BF] text-lg ml-2' />
