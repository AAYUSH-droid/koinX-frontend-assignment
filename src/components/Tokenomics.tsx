function Tokenomics() {
  return (
    <div className='bg-white h-max rounded-lg my-5 p-6 font-inter'>
      <div className='text-[#0F1629] text-[24px] leading-[28.8px] font-semibold'>
        Tokenomics
      </div>
      <div className='my-6'>
        <div className='text-[#1D1D1D] text-[20px] leading-[36px] font-semibold'>
        ...
        <div className='py-4 flex '>
          ...
          <div className='flex flex-col justify-center ml-8'>
            <div className='flex items-center'>
              ...
              <div className='text-[#202020] text-[16px] leading-[20px] font-normal ml-4'>
        ...
        <div className='text-[#3E424A] text-[16px] py-2 leading-[25.6px]'>
