function Tokenomics() {
  return (
    <div className='bg-white h-max rounded-lg my-5 p-6'>
      <div className='text-[#0F1629] text-2xl font-semibold font-inter top-[-1px] tracking-normal	text-left leading-[29px]'>
        Tokenomics
      </div>
      <div className='my-6'>
        <div className='text-[#1D1D1D] text-xl font-semibold font-inter leading-[36px]'>
        ...
        <div className='py-4 flex '>
          ...
          <div className='flex flex-col justify-center ml-8'>
            <div className='flex items-center'>
              ...
              <div className='text-[#202020] text-[16px] font-normal ml-4 font-inter leading-[20px]'>
        ...
        <div className='text-[#3E424A] text-[16px] py-2 font-inter font-medium leading-[25.6px]'>
