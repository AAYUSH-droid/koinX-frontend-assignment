...
function Navbar() {
  ...
  return (
    <div className='lg:h-20 h-16 flex items-center justify-between shadow-[#1026490F]/10  shadow-md bg-[#FFFFFF]  w-screen font-inter'>
      <div>
      ...
      <div className='hidden lg:flex items-center text-[16px]'>
        ...
        <div>
          <button className='bg-gradient-to-r from-[#2870EA] to-[#1B4AEF] px-8 py-2 text-white rounded-lg mx-14 font-semibold '>
            Get Started
          </button>
        </div>
      </div>
      ...
      {/* Popup menu */}
      {isOpen && (
        <div className='lg:hidden absolute w-full top-[4em] border-zinc-100 z-10 right-0 mt-2 mr-2 bg-white rounded-md shadow-md py-5'>
