...
function About() {
  return (
    <div className='bg-white h-max rounded-lg my-5 lg:p-6 p-2 font-inter'>
      <div>
        <div className='text-[24px] font-semibold text-[#0F1629] leading-[28.8px]'>
          About Bitcoin
        </div>
        <div className='mt-6 '>
          <div className='text-[18px] font-bold text-[#0B1426] leading-[21.6px]'>
            What is Bitcoin?
          </div>
          <div className='mt-2 text-[16px] pb-4 text-[#3E424A] font-medium border-b-2 border-[#C9CFDD]/40 leading-[25.6px]'>
        ...
        <div className='mt-2 border-b-2 border-[#C9CFDD]/40 pb-4'>
          <div className='text-lg text-[#0B1426] font-bold leading-[21.6px]'>
            Lorem ipsum dolor sit amet
          </div>
          <div className='text-[16px] leading-[25.6px] text-[#3E424A] font-medium'>
            <div className='mt-2'>
        ...
        <div className=' mt-2 py-2'>
          <div className='text-[#0F1629] text-[24px] font-semibold leading-[28.8px]'>
        ...
        <div className='my-2 text-[#3E424A] font-medium leading-[25.6px]'>
          Fermentum hendrerit imperdiet nulla viverra faucibus. Sit aliquam
          massa vel convallis duis ac. Mi adipiscing semper scelerisque
          porttitor pulvinar nunc risus. Fermentum potenti iaculis lacinia
          congue ipsum fames amet dui. Purus ultrices tincidunt volutpat in
